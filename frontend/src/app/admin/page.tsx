  ...
  return (
    <ProtectedRoute rolesPermitidos={['ADMIN']}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px' }}>
        ...
        {/* TEMAS Y SUBTEMAS */}
        {pestana === 'temas' && (
          <TemasTab temas={temas} mostrarMensaje={mostrarMensaje} cargarDatos={cargarDatos} />
        )}

        {/* PREGUNTAS */}
        {pestana === 'preguntas' && (
          <PreguntasTab temas={temas} mostrarMensaje={mostrarMensaje} cargarDatos={cargarDatos} />
        )}

        {/* PREGUNTAS ALEATORIAS */}
        {pestana === 'aleatorias' && (
          <PreguntasAleatoriasTab temas={temas} mostrarMensaje={mostrarMensaje} cargarDatos={cargarDatos} />
        )}

        {/* USUARIOS */}
        {pestana === 'usuarios' && (
          <UsuariosTab usuarios={usuarios} miId={miId} mostrarMensaje={mostrarMensaje} cargarDatos={cargarDatos} />
        )}
