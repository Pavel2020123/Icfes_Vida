    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            href="/dashboard"
            style={{
              color: "var(--marca-superficie-fuerte, #d2e0fb)",
              textDecoration: "none",
              fontSize: 14,
              fontWeight: 600,
            }}
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px" }}>
        ...
        >
          ...
          <div
            style={{
              background: "linear-gradient(135deg, var(--color-primario, #146c94) 0%, var(--marca-gradiente, #1683a6) 100%)",
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              {editando ? (
                ...
                <p
                  style={{
                    fontSize: 15,
                    color: descripcion ? "#1a2a3a" : "#8a9aaa",
                    lineHeight: 1.6,
                  }}
                >
            ...
            {editando ? (
              <div style={{ display: "flex", gap: 12 }}>
                <button
                  ...
                  disabled={guardando}
                  style={{
                    backgroundColor: guardando ? "var(--marca-borde, #afd3e2)" : "var(--color-primario, #146c94)",
                    color: guardando ? "#425563" : "var(--color-sobre-primario, #ffffff)",
                    padding: "11px 28px",
                    borderRadius: 10,
                    border: "none",
                    fontSize: 15,
                ...
                <button
                  onClick={() => {
                    ...
                    setFotoPreview(perfil.fotoPerfil ?? null);
                  }}
                  style={{
                    backgroundColor: "#ffffff",
                    color: "#4a5a6a",
        ...
        >
          {[
            {
              label: "XP Total",
              valor: `${perfil.xpTotal ?? 0}`,
              sub: "puntos de experiencia",
            },
            {
              label: "Progreso",
              valor: `${progreso.porcentajeGeneral}%`,
              sub: "del curso completado",
            },
            {
              label: "Temas",
              valor: `${progreso.temasCompletados}/${progreso.totalSubtemas}`,
              sub: "temas completados",
            },
          ].map((stat) => (
            <div
              key={stat.label}
